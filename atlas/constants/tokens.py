...
COM_R_RATIO=0.015
ARROW_HEAD_RATIO=0.22; ARROW_WIDTH_RATIO=0.07; ARROW_SHAFT_RATIO=0.024
ARROW_N_RATIO=2.5; ARROW_MG_RATIO=2.0; ARROW_T_RATIO=2.3; ARROW_F_RATIO=1.2
ARROW_SCALE_FIXED="fixed"; ARROW_SCALE_PHYSICAL="physical"
ARROW_F_REFERENCE=9.8
LABEL_SIZE_RATIO=1.7; LABEL_GAP_RATIO=0.15; LABEL_OFFSET_RATIO=0.20
